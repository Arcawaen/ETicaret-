...
using BCrypt.Net; // Şifre hashleme
...
namespace Eticaret.WebUI.Controllers
{
    ...
    <button type=""button"" class=""btn-close"" data-bs-dismiss=""alert"" aria-label=""Close""></button>
        ...
        public async Task<IActionResult> SignUpAsync(AppUser appUser)
        {
            ...
            if (ModelState.IsValid)
            {
                appUser.Password = BCrypt.Net.BCrypt.HashPassword(appUser.Password); // Şifreyi hashle
    ...
    <button type=""button"" class=""btn-close"" data-bs-dismiss=""alert"" aria-label=""Close""></button>
        ...
        public async Task<IActionResult> PasswordChange(string user, string Password)
        {
            ...
            appUser.Password = BCrypt.Net.BCrypt.HashPassword(Password); // Şifreyi hashle
